  ...
  class AudioPlayer extends HTMLElement {
    ...
    updateFrequency() {
      ...
      for (let i = 0; i < barCount; i++) {
        ...
        this.canvasCtx.fillStyle = `rgba(${frequency}, 100, 255)`;
      ...
      <style>
        ...
        * {
        ...
        .play-btn {
            ...
            min-width: 45px;
            height: 45px;
            background: url("/pictures/audio-player-icon-sprite.png") 0 center/500% 100% no-repeat;
            appearance: none;
        ...
        margin-top: 25px;
        margin-right: 20px;
        width:80px; height:80px; border:3px solid white; border-radius: 70%; display: flex; justify-content: center; align-items: center;}
        
        .play-btn.playing {
            background: url("/pictures/audio-player-icon-sprite.png") 25% center/500% 100% no-repeat;
        }
        ...
        .volume-bar.half {
            background: url("/pictures/audio-player-icon-sprite.png") 75% center/500% 100% no-repeat;
        }
        .volume-bar.over {
            background: url("/pictures/audio-player-icon-sprite.png") 100% center/500% 100% no-repeat;
        }
       ...
       ${this.style()}
        <figure class="audio-player">
          ...
          <div class="progress-indicator">
              ...
              <canvas class="visualizer" style="width: 100%; height: 120px"></canvas>
          </div>
